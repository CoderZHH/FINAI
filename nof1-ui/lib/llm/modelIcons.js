const IMAGE_ICON_OPTIONS = [
  { value: "icon:gpt", label: "GPT", src: "/icons/models/GPT.png" },
  ...
  { value: "icon:qwen", label: "Qianwen", src: "/icons/models/QIANWEN.png" },
  { value: "icon:zhipu", label: "Zhipu", src: "/icons/models/ZHIPU.png" },
  { value: "icon:kimi", label: "Kimi", src: "/icons/models/KIMI.png" },
